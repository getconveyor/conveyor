...
import { useApiKeys } from "@/hooks/use-apikey";
            ...
            <Alert>
              ...
              <AlertDescription>
                <ul className="space-y-2 text-sm mt-2">
                  ...
                  <li>
                    ✓ Use different keys for different environments (dev,
                    staging, production)
                  </li>
                  <li>✓ Monitor key usage and investigate unusual activity</li>
                  <li>
                    ⚠ If a key is compromised, delete it immediately and create
                    a new one
                  </li>
                </ul>
              </AlertDescription>
