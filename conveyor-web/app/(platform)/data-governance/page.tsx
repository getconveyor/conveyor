...
export default function DataGovernancePage() {
  const stats = [
    { title: "Catalog Assets", value: "3,247", change: "+142 this month", icon: IconBook },
    { title: "Active Policies", value: "68", change: "12 enforced", icon: IconShield },
    { title: "Compliance Score", value: "97.2%", change: "+1.8% this week", icon: IconCheck },
    { title: "Access Requests", value: "24", change: "18 pending", icon: IconLock },
  ]

  const recentActivity = [
    { action: "Policy Applied", resource: "customer_data table", user: "Admin", status: "success" as const },
    { action: "Access Granted", resource: "sales_reports view", user: "Sarah Chen", status: "success" as const },
    { action: "Lineage Updated", resource: "analytics_pipeline", user: "System", status: "success" as const },
    { action: "Compliance Alert", resource: "pii_exposure", user: "System", status: "warning" as const },
  ]
    ...
    <>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Manage data quality, lineage, compliance, and access control across your platform
            </p>
          </div>
        </div>
        <Button asChild>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Latest governance actions and events</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Policy compliance across data assets</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-sm font-medium">2,847 assets (87.7%)</span>
                </div>
                <div className="w-full bg-muted rounded-full h-2">
                  <div className="bg-green-500 h-2 rounded-full" style={{ width: "87.7%" }} />
                </div>
              </div>
              <div>
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm">Pending Review</span>
                  <span className="text-sm font-medium">324 assets (10.0%)</span>
                </div>
                <div className="w-full bg-muted rounded-full h-2">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Sensitive data distribution across platform</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-sm font-medium">1,247 assets (38.4%)</span>
              </div>
              <div className="w-full bg-muted rounded-full h-2">
                <div className="bg-green-500 h-2 rounded-full" style={{ width: "38.4%" }} />
              </div>
            </div>
            <div>
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm">Internal Data</span>
                <span className="text-sm font-medium">1,542 assets (47.5%)</span>
              </div>
              <div className="w-full bg-muted rounded-full h-2">
                <div className="bg-blue-500 h-2 rounded-full" style={{ width: "47.5%" }} />
              </div>
            </div>
            <div>
              <div className="flex items-center justify-between mb-2">
              ...
              <div className="w-full bg-muted rounded-full h-2">
                <div className="bg-orange-500 h-2 rounded-full" style={{ width: "11.8%" }} />
              </div>
            </div>
            <div>
              <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-green-600/80 dark:text-green-400/80 mt-1">
                  98.5% of sensitive data assets have proper access controls in place
                </p>
              </div>
            </div>
          </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Comprehensive data governance with catalog, lineage tracking, policy management, and compliance monitoring
          </CardDescription>
        </CardHeader>
        <CardContent>
