...
import { IconTable, IconRefresh, IconSearch, IconDatabase } from "@tabler/icons-react";
...
export default function TablesPage() {
  ...
  const loadTables = async () => {
    setIsLoading(true);
    try {
      const params = layerFilter !== "all" ? { layer: layerFilter as "bronze" | "silver" | "gold" } : {};
            ...
            .map(([layer, layerTables]) => (
              <div key={layer} className="space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="text-lg font-semibold capitalize">{layer} Layer</h2>
                      ...
                      <CardContent className="p-4">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-sm text-muted-foreground truncate">{table.namespace}</p>
        ...
        <CardContent className="p-4">
          <div className="flex items-center justify-between text-sm">
            <span className="text-muted-foreground">
              Total: {filteredTables.length} table{filteredTables.length !== 1 ? "s" : ""}
            </span>
            <div className="flex items-center gap-4 text-muted-foreground">
              <span>Catalog: iceberg</span>
